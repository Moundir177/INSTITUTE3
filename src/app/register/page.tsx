            ...
            <Card className="py-4 shadow-xl border border-gray-200 dark:border-gray-700">
              <CardBody className="px-8 py-4">
                  ...
                  <div>
                    ...
                    >
                      <span className="text-sm text-gray-600 dark:text-gray-400">
                        I agree to the <Link href="/terms" className="text-uk-blue dark:text-uk-gold hover:underline">Terms of Service</Link> and <Link href="/privacy-policy" className="text-uk-blue dark:text-uk-gold hover:underline">Privacy Policy</Link>
                      </span>
                    </Checkbox>
                  </div>
                ...
                <p className="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <Link href="/login" className="text-uk-blue dark:text-uk-gold hover:underline">
                    Sign in
                  </Link>
                </p>
              </CardBody>
